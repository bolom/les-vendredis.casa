const GALLERY = [
  ...
  { src: "public/images/cabane-aframe-jardin-fleurs-rouges-les-vendredis.jpg", title: "The A-Frame", titleFr: "L'A-frame", desc: "The A-frame seen through tropical foliage, red flowers, Waba shingles, and blue sky.", descFr: "L'A-frame vue à travers le jardin tropical, les fleurs rouges, le bardage en wapa et le ciel bleu." },
  ...
  { src: "public/images/cuisine-ouverte-jardin-les-vendredis.webp", title: "Open Kitchen", titleFr: "Cuisine ouverte", desc: "An open kitchen flowing onto the garden, built for outdoor living.", descFr: "Une cuisine ouverte sur le jardin, construite pour la vie dehors." },
  { src: "public/images/detail-cuisine-preparation-les-vendredis.webp", title: "Cooking", titleFr: "Préparation", desc: "Cooking in the open air, with views of the tropical garden.", descFr: "Cuisiner en plein air, avec vue sur le jardin tropical." },
  ...
  { src: "public/images/construction-bardage-bois-cabane-aframe-martinique.jpg", title: "The Cladding", titleFr: "Le bardage", desc: "Waba shingles covering the frame, when the A-frame started looking finished.", descFr: "Le bardage en wapa couvre l'ossature, le moment où l'A-frame devient vraiment elle-même." },
