---
layout: article
title: "Pourquoi on a choisi les toilettes sèches."
seo_title: "Toilettes sèches aux Vendredis — simples, locales, sans eau potable"
summary: "Au début, ce n'était pas une grande décision écologique. On avait besoin de toilettes, pas le budget pour une fosse septique, et la solution simple s'est imposée."
...
permalink: /fr/journal/toilettes-seches/
---
...
![Intérieur de la cabine des toilettes sèches]({{ '/images/toilette-seche-interieur-cabine.webp' | relative_url }})
...
![Stockage de la sciure pour les toilettes sèches]({{ '/images/toilette-seche-stockage-sciure.webp' | relative_url }})
...
![Façade de la cabine des toilettes sèches]({{ '/images/toilette-seche-facade.webp' | relative_url }})
...
![Trou de compost dédié aux déjections des toilettes sèches aux Vendredis]({{ '/images/toilettes-seches-trou-dejections-compost-les-vendredis.webp' | relative_url }})

Cette règle n'est pas négociable.

![Cabine privée des toilettes sèches avec parois en bois]({{ '/images/toilette-seche-cabine-privee.webp' | relative_url }})
