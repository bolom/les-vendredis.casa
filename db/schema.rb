...
ActiveRecord::Schema[8.0].define(version: 2026_09_08_154000) do
  ...
  create_table "booking_notifications", force: :cascade do |t|
    t.bigint "booking_inquiry_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["booking_inquiry_id", "event"], name: "index_booking_notifications_on_booking_inquiry_id_and_event", unique: true
    t.index ["booking_inquiry_id"], name: "index_booking_notifications_on_booking_inquiry_id"
  end
  ...
  create_table "journal_posts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["locale", "slug"], name: "index_journal_posts_on_locale_and_slug", unique: true
    t.index ["published", "published_on"], name: "index_journal_posts_on_published_and_published_on"
    t.index ["translation_key"], name: "index_journal_posts_on_translation_key"
  end
  ...
  create_table "payment_orders", force: :cascade do |t|
    ...
    t.jsonb "settlement"
    t.bigint "booking_inquiry_id"
    t.bigint "availability_block_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "reconciliation"
    t.index ["authorization_key"], name: "index_payment_orders_on_authorization_key", unique: true
  ...
  create_table "stay_rules", force: :cascade do |t|
    ...
    t.check_constraint "nightly_price_eur IS NULL OR nightly_price_eur > 0::numeric", name: "stay_rules_positive_price"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "technical_access", default: false, null: false
  ...
  add_foreign_key "payment_orders", "availability_blocks"
  add_foreign_key "payment_orders", "booking_inquiries"
